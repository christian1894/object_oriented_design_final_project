...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("0O9mIOGIqoMCx83FtohQfJbWi")
                .setOAuthConsumerSecret("TTQhNIyL2jWDkeZkRVHpb0DrX50ObWSc0TCKw0gGKkdBn6OVqx")
                .setOAuthAccessToken("1154432122851143686-vUUvR1W3rNQNxD7mKwf3W2HWM4uSnI")
                .setOAuthAccessTokenSecret("tjAYKUYCq3cBC9rSALIUFJSg0rpRJRPVbkviAgPguG0Cz");
